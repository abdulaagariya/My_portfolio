    ...
    <div id="skills">
      <div className=" container m-auto  mt-16">
        ...
        >
          ...
          <img className="w-[40px] h-[40px] md:w-[35px] md:h-[35px]" src= https://icons8.com/icon/UFXRpPFebwa2/mysql-logo"/>
         <img className="w-[40px] h-[40px] md:w-[35px] md:h-[35px]" src= https://www.flaticon.com/free-icon/php_5968332"/>
